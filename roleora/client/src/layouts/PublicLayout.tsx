        ...
        <div className="container-xl">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <Link to={ROUTES.HOME} className="flex items-center gap-2 mb-4">
                ...
                <span className="font-display font-bold text-white">Roleora</span>
              </Link>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-slate-500">
              © {new Date().getFullYear()} Roleora Ltd. Roleora is not a recruitment agency. We do not guarantee interviews or offers.
            </p>
