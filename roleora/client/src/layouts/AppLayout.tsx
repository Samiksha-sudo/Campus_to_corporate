...
import {
  LayoutDashboard, FileText, Briefcase, Star, BarChart2,
...
const navItems = [
  ...
  { label: 'Evidence Bank', href: ROUTES.EVIDENCE,      icon: Star            },
        ...
        <div className="flex items-center justify-between h-16 px-3 border-b border-slate-100 shrink-0">
          {!sidebarCollapsed && (
            <Link to={ROUTES.HOME} className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-slate-900">Roleora</span>
            </Link>
          )}
          <button
