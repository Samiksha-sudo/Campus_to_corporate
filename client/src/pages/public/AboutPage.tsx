...
const values = [
  {
    ...
    body: 'Campus to Corporate never applies to a job on your behalf without your explicit say-so. You are always in control of your career.',
  },
  {
    icon: '🤝',
    ...
    <>
      ...
      <section className="section-padding pt-24 pb-16 bg-gradient-to-b from-slate-50 to-white">
        <div className="container-xl max-w-3xl">
          <p className="eyebrow mb-4">About Campus to Corporate</p>
          <h1 className="text-5xl font-display font-extrabold text-slate-900 mb-6">
            A better way to manage your career
          </h1>
          <p className="text-xl text-slate-600 leading-relaxed">
            Campus to Corporate was built for UK professionals who are serious about their next move. We combine
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  Campus to Corporate gives you the structure, the AI tools, and the human specialists that were previously
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 rounded-xl p-5">
                ...
                <p className="text-sm text-slate-500">
                  Campus to Corporate does not place candidates or earn fees from employers. We work only for you.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-white border-t border-slate-100">
        <div className="container-xl max-w-2xl mx-auto text-center">
          <p className="text-sm text-slate-400 leading-relaxed mb-8">
            Campus to Corporate is not a recruitment agency. We do not guarantee interviews, offers, or specific
